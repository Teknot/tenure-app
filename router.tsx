...
import i18n from "./src/locales/localization";
...
const toastConfig = {
  ...
  */
  error: (props) => (
    <ErrorToast
      {...props}
      style={{ borderLeftColor: '#EBC55B', backgroundColor : '#EBC55B' }}
      text1Style={{
        fontSize: 15,
        color : 'black',
        fontWeight:'400'
...
function HomeStack() {
  ...
  return (
    <Tab.Navigator
      ...
      screenOptions={{
        headerShown: false,
        tabBarActiveBackgroundColor: '#38857B',
        tabBarInactiveBackgroundColor: '#38857B',
        tabBarShowLabel: true,
        tabBarActiveTintColor: '#FFFFFF',
        tabBarInactiveTintColor: '#8AAEC9',
        tabBarLabelStyle:{
          // backgroundColor:'red',
          position:'absolute',
